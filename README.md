...
In this project we numerically calculate the distribution of acquaterra exploiting the outputs of [SELEN](https://github.com/geodynamics/selen), an open 
...
associated with the variation of the rotational axis of Earth. To do so, [SELEN](https://github.com/geodynamics/selen) applies an icosahedron-based pixellization
...
Among the many outputs given by [SELEN](https://github.com/geodynamics/selen) we are interested in the solution of the **Continental Function** (CF).
...
specifically designed to elaborate some  [SELEN](https://github.com/geodynamics/selen)'s outputs, specifically the CF and the topography, in order to calculate 
...
of the structure and the method used in the project, and of the output files is illustrated in [MANUAL.md](MANUAL.md) file
