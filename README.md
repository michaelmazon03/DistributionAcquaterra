...
source software which solves the __sea-level equation__ in its complete version; that is, it takes into account
...
CF(\gamma,t) = 
\begin{cases} 
      1 & \text{if } \hspace{0.5cm}
    \gamma \text{ is exposed land}\\
